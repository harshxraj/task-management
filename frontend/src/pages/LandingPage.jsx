  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        <span className="mb-1.5 inline-block rounded-full bg-gray-600/50 px-3 py-1.5 text-normal">
          {user.token
            ? "Hello " + user.fullname + "👋"
        ...
        <p className="my-6 max-w-xl text-center text-base leading-relaxed md:text-lg md:leading-relaxed">
          Welcome to Taskify! Our app streamlines task management, enabling you
          to effortlessly create to-do items and set priority levels with a
